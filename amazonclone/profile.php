	...
	<div class="navbar navbar-default navbar-fixed-top"  id="topnav">
		<div class="container-fluid">
			<div class="navbar-header">
				<a><IMG SRC="fav.png" ALT="some text" WIDTH=70 HEIGHT=50></IMG></a>
				<a href="index.php" class="navbar-brand">Product Shopping</a>
			</div>

			<ul class="nav navbar-nav">

				<li style="width:300px;left:10px;top:10px;margin-left: -90px;"><input type="text" class="form-control" id="search" name=""></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li id='shoppingcart'><a id="carticon" href="#" class="dropdown-toggle" data-toggle="dropdown" style="margin-right: 60px;"><span class="glyphicon glyphicon-shopping-cart"></span>Cart <span class="badge">1</span>	</a>
