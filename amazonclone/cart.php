	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="row">
				...
				<input type="button" name="Continue Shopping" class='btn btn-success btn-lg pull-right' id='checkout_btn' data-toggle="modal" data-target="#myModal" onclick="location.href='profile.php'" value="Continue Shopping" style="margin-right: 10px">
			</div>
